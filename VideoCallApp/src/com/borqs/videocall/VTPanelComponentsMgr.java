...
public class VTPanelComponentsMgr implements VTPanel.IPanelManager {
    ...
    class SetCameraDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (mApp.mCurrentVideoSource == VTManager.VideoSource.CAMERA_SECONDARY) {
                mSkBarContast.setVisibility(View.GONE);
                mSkBarBright.setVisibility(View.GONE);
            } else {
    ...
    private boolean initComponents() {
        ...
        TextView tv = (TextView)mScreen.findViewById(R.id.tv_shelf) ;
        tv.setHeight(78) ;

        TextView tv2 = (TextView)mScreen.findViewById(R.id.tv_shelf_2) ;
        tv.setHeight(78) ;
    ...
    void initSubComponents() {
        ...
        // mUserInputView = (EditText) mScreen.findViewById(R.id.vt_user_input);
        ...
        if ("qwertybar".equals(SystemProperties.get("hw.formfactor"))) {
            ...
            Button btnTouchOne = (Button) mScreen.findViewById(R.id.touch_one);
            if (btnTouchOne != null) {
                btnTouchOne.setFocusable(false);
            }
            Button btnTouchTwo = (Button) mScreen.findViewById(R.id.touch_two);
            if (btnTouchTwo != null) {
                btnTouchTwo.setFocusable(false);
            }
            Button btnTouchThree = (Button) mScreen.findViewById(R.id.touch_three);
            if (btnTouchThree != null) {
                btnTouchThree.setFocusable(false);
            }
            Button btnTouchFour = (Button) mScreen.findViewById(R.id.touch_four);
            if (btnTouchFour != null) {
                btnTouchFour.setFocusable(false);
            }
            Button btnTouchFive = (Button) mScreen.findViewById(R.id.touch_five);
            if (btnTouchFive != null) {
                btnTouchFive.setFocusable(false);
            }
            Button btnTouchSix = (Button) mScreen.findViewById(R.id.touch_six);
            if (btnTouchSix != null) {
                btnTouchSix.setFocusable(false);
            }
            Button btnTouchSeven = (Button) mScreen.findViewById(R.id.touch_seven);
            if (btnTouchSeven != null) {
                btnTouchSeven.setFocusable(false);
            }
            Button btnTouchEight = (Button) mScreen.findViewById(R.id.touch_eight);
            if (btnTouchEight != null) {
                btnTouchEight.setFocusable(false);
            }
            Button btnTouchNine = (Button) mScreen.findViewById(R.id.touch_nine);
            if (btnTouchNine != null) {
                btnTouchNine.setFocusable(false);
            }
            Button btnTouchStar = (Button) mScreen.findViewById(R.id.touch_star);
            if (btnTouchStar != null) {
                btnTouchStar.setFocusable(false);
            }
            Button btnTouchZero = (Button) mScreen.findViewById(R.id.touch_zero);
            if (btnTouchZero != null) {
                btnTouchZero.setFocusable(false);
            }
            Button btnTouchPound = (Button) mScreen.findViewById(R.id.touch_pound);
        ...
        mBtnCapturePhoto.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View view, MotionEvent event) {
                ...
                case MotionEvent.ACTION_DOWN:
                    mBtnCapturePhoto
                            .setBackgroundResource(R.drawable.cmcc_phone_dialer_btn_bg_pressed);
                    break;
        ...
        // mBtnSwitchCamera = mScreen.findViewById(R.id.btn_switch_camera);
        // mBtnSwitchCamera.setOnTouchListener(new View.OnTouchListener() {
        // public boolean onTouch(View view, MotionEvent event) {
        // // TODO Auto-generated method stub
        // switch (event.getAction()) {
        // case MotionEvent.ACTION_DOWN:
        // mBtnSwitchCamera.setBackgroundResource(R.drawable.cmcc_phone_dialer_btn_bg_pressed);
        // break;
        // case MotionEvent.ACTION_CANCEL:
        // mBtnSwitchCamera.setBackgroundResource(0);
        // break;
        // case MotionEvent.ACTION_UP:
        // //mScreen.showDialog(VideoCallScreen.BUSY_DIALOG);
        // if (!isProgressing) {
        // if (MyLog.DEBUG) MyLog.v(TAG, "mBtnSwitchCamera event:" );
        // isProgressing = true;
        // focusButton = mBtnSwitchCamera;
        // progressDlg =
        ...
        // mBtnRemoteWindow = mScreen.findViewById(R.id.btn_swap_window_remote);
        // mBtnRemoteWindow.setOnTouchListener(new View.OnTouchListener() {
        //
        ...
        // }
        // });
        mImgSwapWindow = (ImageView) mScreen.findViewById(R.id.btn_swap_window);
        updateSwapStaus();
        mImgSwapWindow.setOnTouchListener(new View.OnTouchListener() {
        ...
        mBtnSwitchSpeaker.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                if (VTServiceInterface.isSpeakerOn(mApp.getApplicationContext())) {
                    ...
                    // toSpeaker.setImageResource(R.drawable.cmcc_phone_vtcall_icon_speaker_hl);
                }
                mMainPanel.cancelDelayedSwitchMode();
    ...
    public void updateSwapStaus() {
        if (VideoCallApp.sPanelMode == VTPanel.VTPANEL_MODE_LOCAL)
            mImgSwapWindow.setImageResource(R.drawable.ic_swap_pressed);
        else
            mImgSwapWindow.setImageResource(R.drawable.ic_swap);
    ...
    void showRepImage() {
        ...
        try {
            ...
            bm = Bitmap.createBitmap(176, 234, Bitmap.Config.ARGB_8888);
            int start_y = 69;
            for (int y = start_y; y < (start_y + 144) ; y++)
                for (int x = 0; x < 176; x++)
